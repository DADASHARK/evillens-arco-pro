export default {
  'menu.dashboard.workplace': '展示页',
  'workplace.welcome': '欢迎来到EvilLens！',
  ...
  'workplace.quick.operation': 'EvilLers:儿童邪典视频挖掘与治理',
  'workplace.quickOperation.setup': '管理',
  'workplace.allProject': '所有项目',
  'workplace.loadMore': '加载更多',
  'workplace.viewMore': '查看更多',
  'workplace.contentData': '典型邪典视频展示',
  'workplace.contentTitle': '标题:',
  'workplace.contentTag': '标签:',
