<template>
  <a-spin :loading="loading" style="width: 100%">
    ...
    >
          ...
          <div class="carousel-video-item">
            ...
            <div class="carousel-video-title">
              <div class="carousel-title"
                >{{ $t('workplace.contentTitle') }} {{ video.mainTitle }}</div
              >
              <div class="carousel-tags"
                >{{ $t('workplace.contentTag') }}{{ video.tags.join(' ') }}</div
              >
            </div>
          </div>
        </a-carousel-item>
        <!-- <a-carousel-item v-for="video in videos" :key="video.videoId">
          <div class="carousel-video-item">
            <img :src="video.coverimgUrl" class="carousel-video-cover" />
            <div class="carousel-video-title">
              <div>{{ $t('workplace.contentTitle') }} {{ video.mainTitle }}</div>
              <div>{{ $t('workplace.contentTag') }}{{ video.tags.length ? video.tags.join(' ') : '无' }}</div>
            </div>
          </div>
        </a-carousel-item> -->
      </a-carousel>
      ...
      <!-- 原有的 evil-video-list 可以删除或注释 -->
      <!-- <div class="evil-video-list"> ... </div> -->
    </a-card>
  </a-spin>
</template>
...
<style scoped lang="less">
  ...
  // .evil-video-title {
  //   font-size: 10px;
  //   color: var(--color-text-1); // 使用 Arco Design 的变量，会自动适应暗黑模式
  //   font-family: 'Orbitron', 'Roboto Mono', 'Consolas', 'monospace', sans-serif;
  //   white-space: nowrap;
  //   overflow: hidden;
