export default {
  'menu.dashboard.workplace': 'videos',
  'workplace.welcome': 'Welcome to EvilLens!',
  ...
  'workplace.contentData': 'Cult video display data',
  'workplace.contentTitle': 'TITLE:',
  'workplace.contentTag': 'TAG:',
